...
export default function Index() {
  ...
  const articleComponent = filteredArticles.map((article, index) =>
  ...
  return (
    <>
      ...
      <div className="content-wrapper">
        ...
        <div>There is a bug in pagination, sometimes clicks doesn't work, after a while it will work</div>
      </div>
    </>
  )
}
